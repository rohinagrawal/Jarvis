...
Jarvis is a Python project managed with `uv`. Entry point: `main.py`. Dependencies and project metadata: `pyproject.toml` / `uv.lock`.
...
├── .env.example           # Optional local overrides template
...
This repo wires up two thin adapters:
